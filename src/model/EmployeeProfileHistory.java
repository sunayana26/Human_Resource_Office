...
public class EmployeeProfileHistory {
    ...
    this.history= new ArrayList<EmployeeProfile>();
     addNewEmployee(new EmployeeProfile("Juan",100,23,"Male","23 Sept 2022",13,"CNAS","Front-End Developer",12312123,"john@n.co"));
        addNewEmployee(new EmployeeProfile("Julie",101,25,"Female","23 Jan 2021",10,"YELLOW","Back-End Developer",12312123,"jose@n.co"));
        addNewEmployee(new EmployeeProfile("Adam",102,27,"Male","22 Oct 2019",8,"ORANGE","Senior Developer",12312123,"adam@n.co"));
        addNewEmployee(new EmployeeProfile("Mary",103,30,"female","23 April 2016",6,"CNAS","Project Manager",12312123,"jose@n.co"));
